 ...
 */
class excusesbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "excuses@excuses";
    public $boxlabel;
    public $depends = array("excuses");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/excuses/class/excuses.class.php";
